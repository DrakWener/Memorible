  ...
  return (
    <ul>
      ...
      <li className='h-12 text-lg hover:bg-gray-200 active:ring-black active:ring-2 cursor-pointer px-6 font-semibold rounded-full flex items-center mb-1'>
        ...
        <span className='ml-1.5 pt-1'>Home</span>
      </li>
      ...
      <li className='h-12 text-lg hover:bg-gray-200 active:ring-black active:ring-2 cursor-pointer px-6 font-semibold rounded-full flex items-center mb-1'>
        ...
        <span className='ml-1.5 pt-1'>Categories</span>
      </li>
      ...
      <li className='h-12 text-lg hover:bg-gray-200 active:ring-black active:ring-2 cursor-pointer px-6 font-semibold rounded-full flex items-center mb-1'>
        ...
        <span className='ml-1.5 pt-1'>DashBoard</span>
      </li>
      ...
      <li className='h-12 text-lg hover:bg-gray-200 active:ring-black active:ring-2 cursor-pointer px-6 font-semibold rounded-full flex items-center mb-1'>
        ...
        <span className='ml-1.5 pt-1'>Settings</span>
      </li>
